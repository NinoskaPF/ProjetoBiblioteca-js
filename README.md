...
## 🎯 Objetivo O objetivo deste projeto é aplicar os conhecimentos adquiridos durante o curso de programação, utilizando JavaScript, organização de arquivos, funções, objetos e controle de versão com Git e GitHub.
...
3. Entrar na pasta: cd Projeto-Biblioteca-js
...
## 👤 Autor 
Projeto desenvolvido por: Ninoska Palmares 
Curso: Programação – Front-End Angular 
